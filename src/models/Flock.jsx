...
import scene from '../assets/3d/flock.glb'

const Flock = ({ currentAnimation, ...props}) => {
  const group = useRef()
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]} scale={0.021}>
