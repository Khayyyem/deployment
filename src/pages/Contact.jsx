...
const Contact = () => {
  ...
  const [currentAnimation, setCurrentAnimation] = useState('Scene')
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
      {
        ...
        to_email: 'shaikh3khayyam@gmail.com',
  ...
  const handleFocus = () => setCurrentAnimation('Scene');
  const handleBlur = () => setCurrentAnimation('Scene');
